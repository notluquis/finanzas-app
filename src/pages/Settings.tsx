  ...
  if (!canEdit) {
    return (
      <section className="space-y-4">
        ...
        <p className="border-l-4 border-amber-300/80 bg-gradient-to-r from-amber-50/75 via-white/70 to-white/55 p-6 text-sm text-amber-700">
            ...
            className={({ isActive }) =>
              `bg-base-100 flex flex-col gap-1 rounded-2xl border px-5 py-4 transition ${
                isActive
                  ...
                  : "border-white/45 bg-base-100/65 text-slate-700 hover:border-[var(--brand-primary)]/35 hover:bg-[var(--brand-primary)]/8 hover:text-[var(--brand-primary)]"
              }`
            }
          >
