  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {columns.filter(col => col !== "actions").map((column) => (
      ...
      <div className="overflow-hidden rounded-2xl border border-[var(--brand-primary)]/15 bg-white shadow-sm">
        ...
        <tbody>
          ...
          {!employees.length && !loading && (
            <tr>
              <td colSpan={table.getVisibleColumns(columns).length} className="px-4 py-6 text-center text-slate-500">
                No hay registros.
              </td>
            </tr>
          )}
          {loading && (
            <tr>
              <td colSpan={table.getVisibleColumns(columns).length} className="px-4 py-6 text-center text-[var(--brand-primary)]">
                Cargando...
              </td>
            </tr>
          )}
